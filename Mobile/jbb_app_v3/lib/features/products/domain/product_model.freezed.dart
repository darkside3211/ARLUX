...
class _$ProductModelImpl implements _ProductModel {
  ...
  @override
  String toString() {
    return 'ProductModel(id: $id, name: $name, price: $price, description: $description, imageUrl: $imageUrl, averageRating: $averageRating, lensID: $lensID, groupID: $groupID, category: $category, modelUrl: $modelUrl)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, price, description,
      imageUrl, averageRating, lensID, groupID, category, modelUrl);
...
abstract class _ProductModel implements ProductModel {
  factory _ProductModel(
      ...
      final String? modelUrl}) = _$ProductModelImpl;
