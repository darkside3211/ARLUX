            ...
            children: [
              ...
              ListTile(
                onTap: () {
                  showAboutDialog(
                    context: context,
                    applicationName: 'JBB-Gold',
                    applicationVersion: '1.0.0',
                    applicationLegalese: "CC 2024",
                    children: const [
                      Text(
                          "At JBB GOLD, we believe in redefining the way you experience luxury. With a passion for craftsmanship and innovation, we combine timeless jewelry designs with cutting-edge technology to offer a truly immersive shopping experience. Our fine jewelry collection is now more accessible than ever through our advanced 3D viewing and augmented reality (AR) features."),
                      gapH4,
                      Text(
                          "Our 3D view allows you to explore each piece from every angle, showcasing our jewelry's intricate details and beauty, just as if you were holding it in your hands. With our AR capabilities, you can virtually try on rings, necklaces, and more from the comfort of your home, ensuring that every piece you select complements your style perfectly."),
                      gapH4,
                      Text(
                          "At JBB GOLD, we are dedicated to helping you find the perfect piece, blending tradition with innovation to offer an unparalleled jewelry shopping experience."),
                    ],
                  );
                },
                trailing: const Icon(
