<template>
    <v-data-table density="comfortable" show-expand expand-on-click v-model:expanded="expanded" select-strategy="single"
        :sort-by="props.sortBy" :items-per-page="props.itemsPerPage" return-object :search="props.searchQuery" :headers="headers"
        :items="props.orders" :height="props.height" item-value="createdAt" @click:row="setSelected">
        ...
        <template v-slot:item.orderStatus="{ item }">
            <v-btn :variant="item.orderStatus !== 'Completed' ? 'flat' : 'outlined'" :color="setOrderColor(item.orderStatus)" :text="item.orderStatus"
    ...
    <ActionDialog :order="selectedItem" :show="actionDialog" @update:show="actionDialog = $event"
...
const headers = ref([
    { title: 'Customer', key: 'username', align: 'start' },
    { title: 'Date', key: 'updatedAt', align: 'end' },
